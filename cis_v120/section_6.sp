...
control "cis_v120_6_2_1" {
  ...
  query         = query.sql_instance_postgresql_log_checkpoints_database_flag_on.sql
...
control "cis_v120_6_2_5" {
  ...
  query         = query.sql_instance_postgresql_log_duration_database_flag_on.sql
...
control "cis_v120_6_2_6" {
  ...
  query         = query.sql_instance_postgresql_log_lock_waits_database_flag_on.sql
...
control "cis_v120_6_2_8" {
  ...
  query         = query.sql_instance_postgresql_log_hostname_database_flag_configured.sql
...
control "cis_v120_6_2_9" {
  ...
  query         = query.sql_instance_postgresql_log_parser_stats_database_flag_off.sql
...
control "cis_v120_6_2_10" {
  ...
  query         = query.sql_instance_postgresql_log_planner_stats_database_flag_off.sql
...
control "cis_v120_6_2_11" {
  ...
  query         = query.sql_instance_postgresql_log_executor_stats_database_flag_off.sql
...
control "cis_v120_6_2_12" {
  ...
  query         = query.sql_instance_postgresql_log_statement_stats_database_flag_off.sql
...
control "cis_v120_6_2_15" {
  ...
  query         = query.sql_instance_postgresql_log_temp_files_database_flag_0.sql
...
control "cis_v120_6_3_6" {
  ...
  query         = query.sql_instance_sql_3625_trace_database_flag_off.sql
