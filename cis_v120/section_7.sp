locals {
  cis_v120_7_common_tags = merge(local.cis_v120_common_tags, {
    cis_section_id = "7"
  })
}
...
benchmark "cis_v120_7" {
  title         = "7 BigQuery"
  documentation = file("./cis_v120/docs/cis_v120_7.md")
  children = [
...
control "cis_v120_7_1" {
  ...
  query         = query.bigquery_dataset_not_publicly_accessible.sql
  documentation = file("./cis_v120/docs/cis_v120_7_1.md")
...
control "cis_v120_7_2" {
  ...
  query         = query.bigquery_table_encrypted_with_cmk.sql
  documentation = file("./cis_v120/docs/cis_v120_7_2.md")
...
control "cis_v120_7_3" {
  ...
  query         = query.bigquery_dataset_encrypted_with_cmk.sql
  documentation = file("./cis_v120/docs/cis_v120_7_3.md")
