...
**Includes full support for v1.2.0 CIS, v1.3.0 CIS, v2.0.0 CIS, v3.0.0 CIS, CFT Scorecard, Forseti Security, HIPAA, PCI DSS v3.2.1 and NIST CSF v1.0 benchmarks**.
