...
control "cis_v200_2_1" {
  ...
  query         = query.audit_logging_configured_for_all_service.sql
...
control "cis_v200_2_2" {
  ...
  query         = query.logging_sink_configured_for_all_resource.sql
...
control "cis_v200_2_3" {
  ...
  query         = query.logging_bucket_retention_policy_enabled.sql
...
control "cis_v200_2_4" {
  ...
  query         = query.logging_metric_alert_project_ownership_assignment.sql
...
control "cis_v200_2_5" {
  ...
  query         = query.logging_metric_alert_audit_configuration_changes.sql
...
control "cis_v200_2_6" {
  ...
  query         = query.logging_metric_alert_custom_role_changes.sql
...
control "cis_v200_2_7" {
  ...
  query         = query.logging_metric_alert_firewall_rule_changes.sql
...
control "cis_v200_2_8" {
  ...
  query         = query.logging_metric_alert_network_route_changes.sql
...
control "cis_v200_2_9" {
  ...
  query         = query.logging_metric_alert_network_changes.sql
...
control "cis_v200_2_10" {
  ...
  query         = query.logging_metric_alert_storage_iam_permission_changes.sql
...
control "cis_v200_2_11" {
  ...
  query         = query.logging_metric_alert_sql_instance_configuration_changes.sql
...
control "cis_v200_2_12" {
  ...
  query         = query.compute_network_dns_logging_enabled.sql
...
control "cis_v200_2_13" {
  ...
  query         = query.project_service_cloudasset_api_enabled.sql
...
control "cis_v200_2_15" {
  ...
  query         = query.project_access_approval_settings_enabled.sql
...
control "cis_v200_2_16" {
  ...
  query         = query.logging_https_load_balancer_enabled.sql
