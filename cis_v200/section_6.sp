...
locals {
  cis_v200_6_1_common_tags = merge(local.cis_v200_6_common_tags, {
    cis_section_id = "6.1"
  })
}

locals {
  cis_v200_6_2_common_tags = merge(local.cis_v200_6_common_tags, {
    cis_section_id = "6.2"
  })
}

locals {
  cis_v200_6_3_common_tags = merge(local.cis_v200_6_common_tags, {
    cis_section_id = "6.3"
  })
}
...
benchmark "cis_v200_6" {
  ...
  children = [
    benchmark.cis_v200_6_1,
    benchmark.cis_v200_6_2,
...
benchmark "cis_v200_6_1" {
  ...
  children = [
    control.cis_v200_6_1_1,
    control.cis_v200_6_1_2,
    control.cis_v200_6_1_3
  ]

  tags = merge(local.cis_v200_6_1_common_tags, {
    type    = "Benchmark"
    service = "GCP/SQL"
  })
}
...
control "cis_v200_6_1_1" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_1_1.md")
...
control "cis_v200_6_1_2" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_1_2.md")
  query         = query.sql_instance_mysql_skip_show_database_flag_on.sql
...
control "cis_v200_6_1_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_1_3.md")
  query         = query.sql_instance_mysql_local_infile_database_flag_off.sql
...
benchmark "cis_v200_6_2" {
  ...
  children = [
    control.cis_v200_6_2_1,
    control.cis_v200_6_2_2,
    control.cis_v200_6_2_3,
    control.cis_v200_6_2_4,
...
control "cis_v200_6_2_1" {
  ...
  query         = query.sql_instance_postgresql_log_error_verbosity_database_flag_set_default_or_stricter.sql
...
control "cis_v200_6_2_2" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_2_2.md")
  query         = query.sql_instance_postgresql_log_connections_database_flag_on.sql
...
control "cis_v200_6_2_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_2_3.md")
  query         = query.sql_instance_postgresql_log_disconnections_database_flag_on.sql
...
control "cis_v200_6_2_4" {
  ...
  query         = query.sql_instance_postgresql_log_statement_database_flag_set_appropriately.sql
  tags = merge(local.cis_v200_6_2_common_tags, {
    cis_item_id = "6.2.4"
    cis_level   = "1"
    cis_type    = "automated"
...
control "cis_v200_6_2_6" {
  ...
  query         = query.sql_instance_postgresql_log_min_error_statement_database_flag_configured.sql
...
control "cis_v200_6_2_7" {
  ...
  query         = query.sql_instance_postgresql_log_min_duration_statement_database_flag_disabled.sql
...
control "cis_v200_6_2_8" {
  ...
  query         = query.sql_instance_postgresql_cloudsql_pgaudit_database_flag_enabled.sql
...
control "cis_v200_6_2_9" {
  ...
  query         = query.sql_instance_using_private_ip.sql
...
benchmark "cis_v200_6_3" {
  ...
  children = [
    control.cis_v200_6_3_1,
    control.cis_v200_6_3_2,
    control.cis_v200_6_3_3,
    control.cis_v200_6_3_4,
    control.cis_v200_6_3_5,
    control.cis_v200_6_3_6,
    control.cis_v200_6_3_7
  ]
...
control "cis_v200_6_3_1" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_1.md")
  query         = query.sql_instance_sql_external_scripts_enabled_database_flag_off.sql
...
control "cis_v200_6_3_2" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_2.md")
  query         = query.sql_instance_sql_cross_db_ownership_chaining_database_flag_off.sql
...
control "cis_v200_6_3_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_3.md")
  query         = query.sql_instance_sql_user_connections_database_flag_configured.sql
...
control "cis_v200_6_3_4" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_4.md")
  query         = query.sql_instance_sql_user_options_database_flag_not_configured.sql
...
control "cis_v200_6_3_5" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_5.md")
  query         = query.sql_instance_sql_remote_access_database_flag_off.sql
...
control "cis_v200_6_3_6" {
  ...
  query         = query.sql_instance_sql_3625_trace_database_flag_on.sql
...
control "cis_v200_6_3_7" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_6_3_7.md")
  query         = query.sql_instance_sql_contained_database_authentication_database_flag_off.sql
...
control "cis_v200_6_4" {
  ...
  query         = query.sql_instance_require_ssl_enabled.sql
...
control "cis_v200_6_5" {
  ...
  query         = query.sql_instance_not_open_to_internet.sql
...
control "cis_v200_6_6" {
  ...
  query         = query.sql_instance_with_no_public_ips.sql
...
control "cis_v200_6_7" {
  ...
  query         = query.sql_instance_automated_backups_enabled.sql
