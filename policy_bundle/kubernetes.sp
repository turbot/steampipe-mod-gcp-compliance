...
control "allow_only_private_cluster" {
  ...
  query = query.kubernetes_cluster_private_cluster_config_enabled.sql
...
control "disable_gke_dashboard" {
  ...
  query = query.kubernetes_cluster_dashboard_disabled.sql
...
control "disable_gke_default_service_account" {
  ...
  query = query.kubernetes_cluster_service_account_default.sql
...
control "disable_gke_legacy_abac" {
  ...
  query = query.kubernetes_cluster_legacy_abac_enabled.sql
...
control "disable_gke_legacy_endpoints" {
  ...
  query = query.kubernetes_cluster_legacy_endpoints_disabled.sql
...
control "enable_alias_ip_ranges" {
  ...
  query = query.kubernetes_cluster_use_ip_aliases.sql
...
control "enable_auto_repair" {
  ...
  query = query.kubernetes_cluster_auto_repair_enabled.sql
...
control "enable_gke_master_authorized_networks" {
  ...
  query = query.kubernetes_cluster_master_authorized_networks_config_enabled.sql
...
control "gke_container_optimized_os" {
  ...
  query = query.kubernetes_cluster_node_config_image_cos_containerd.sql
...
control "gke_restrict_pod_traffic" {
  ...
  query = query.kubernetes_cluster_network_policy_installed.sql
